 ...
 *  拦截器设置
 */
@property (nonatomic, strong, readonly) id<JMWebResourceInterceptorSettings> settings;

/**
 *  拦截器资源缓存
 */
@property (nonatomic, strong, readonly) JMWebResourceCache *cache;
